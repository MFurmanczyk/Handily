...
class FixRequestCardRecyclerViewAdapter(private val fixRequestList: ArrayList<FixRequest>, private val isClient: Boolean)
    ...
    override fun onFixClicked(v: View, fixUuid: String) {
        val action = FragmentHomeTabsDirections.fixOverviewFragmentDirection(fixUuid, isClient)
